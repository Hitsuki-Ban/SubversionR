...
Assert-Equal 34 ([int](Get-RequiredProperty $nativeProtocol "minor" "vsixPackage.nativeCompatibility.protocol")) "vsixPackage native compatibility protocol minor must be exactly 34."
...
Assert-Equal 34 ([int](Get-RequiredProperty $subsequentProtocol "minor" "vsixPackage.nativeCompatibility.workerIsolation.subsequentDiagnostics.protocol")) "vsixPackage native compatibility subsequent diagnostics protocol minor must match."
