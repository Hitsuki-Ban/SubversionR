...
try {
  ...
  Assert-Equal "32" ([string]$report.nativeCompatibility.protocol.minor) "VSIX package evidence should record the exact worker-isolation protocol minor."
  ...
  Assert-Equal "32" ([string]$report.nativeCompatibility.workerIsolation.subsequentDiagnostics.protocol.minor) "VSIX package evidence should bind subsequent diagnostics to protocol v1.32."
