...
try {
  ...
  Assert-Equal "0.2.2" $rootPackage.version "Root package should declare the current 0.2.2 candidate version."
  ...
  Assert-True ($ciWorkflow.Contains("target/vsix/subversionr-win32-x64-0.2.2.vsix")) "CI should upload the current 0.2.2 VSIX candidate."
