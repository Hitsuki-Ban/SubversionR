...
'@ | Set-Content -LiteralPath $sourceLock -NoNewline
  ...
  Assert-True ($packageJson.scripts."release:generate-publication-gaps:win32-x64".Contains("-MarketplacePublisherAuthorizationEvidencePath docs/release/marketplace-publisher-authorization-evidence.json")) "Publication gaps generation should bind the Marketplace publisher authorization evidence."
