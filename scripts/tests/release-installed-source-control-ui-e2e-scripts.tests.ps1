...
try {
  ...
  Assert-Equal "False" ([string]$report.extension.beforeActive) "Installed Source Control UI E2E evidence should prove SubversionR was inactive before explicit activation."
  Assert-Equal "True" ([string]$report.extension.afterActive) "Installed Source Control UI E2E evidence should prove SubversionR activated on the explicit installed open command."
