...
SubversionR currently publishes the Windows `win32-x64` `0.2.3` Beta through the Marketplace pre-release channel and GitHub Releases. No stable release is currently supported.
