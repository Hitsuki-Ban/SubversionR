...
- `docs/release/github-attestation-evidence.win32-x64.json` records the successful public workflow run `https://github.com/Hitsuki-Ban/SubversionR/actions/runs/29087683655`, attestation `https://github.com/Hitsuki-Ban/SubversionR/attestations/34733676`, exact source-controlled `docs/release/github-attestation-bundle.win32-x64.json` and `docs/release/github-attestation-verification.win32-x64.json` bytes, their SHA256 values, the exact released VSIX subject, signer/source refs and digests, predicate type, and self-hosted-runner denial policy.
