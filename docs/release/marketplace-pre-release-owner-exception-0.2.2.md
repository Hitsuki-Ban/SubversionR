...
Decision sources: public issues [#14](https://github.com/Hitsuki-Ban/SubversionR/issues/14) and [#26](https://github.com/Hitsuki-Ban/SubversionR/issues/26), recorded on 2026-07-11.
...
- asset size: `8251930` bytes;
- asset SHA256: `47d6d9718614bb2e81706af2096e7387fadeeec34db7d6867c3233c8206dc378`.
...
The 0.2.1 exception was not consumed because Marketplace rejected its reserved display name before publication evidence could be recorded. This 0.2.2 authorization is a separate exact-subject decision and does not alter the released or attested 0.2.1 bytes.
