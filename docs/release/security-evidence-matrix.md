...
| `SEC-015` | release-blocker | Deterministic `0.2.1` pre-release VSIX/package evidence, an exact pending candidate attestation contract, candidate/historical provenance separation, historical `0.2.0` live-attestation evidence, pre-Azure live verification workflow, vulnerability decisions, and native artifact mapping | The `0.2.1` release/live attestation, Marketplace publication/public install, final SBOM/NOTICE/legal and vulnerability approval, reproducible or signed source-to-binary provenance, and artifact signing are not complete. |
...
| `MIG-009` | release-blocker | M7 release gates, staged/installed `win32-x64` evidence, M7j2a provenance, M7j3 renderer evidence, M7k2a listing metadata, and the exact deterministic `0.2.1` pre-release VSIX plus pending candidate contract verified through M7k2b/Beta-G | The `0.2.1` release and live attestation, Marketplace/public install, signing/provenance trust, and previous-stable upgrade/rollback are not complete. |
...
| `MIG-012` | release-blocker | Generated NOTICE evidence, exact `0.2.1` candidate contract, historical `0.2.0` attestation evidence, secretless Marketplace workflow, #20 bounded owner exception, vulnerability decisions, and native artifact mapping | Final NOTICE/license publication and legal review, the `0.2.1` release/live attestation, Marketplace publication/public install, signed provenance, artifact signing, and final vulnerability approval are not complete. |
...
| `TST-024` | release-blocker | Installed package/workflow/UI evidence, deterministic pre-release VSIX tests, candidate-versus-historical provenance/publication/Beta-G separation tests, attestation workflow tests, Marketplace recorder tests, vulnerability gates, native artifact mapping, and Source Control UI E2E evidence | Previous-stable upgrade/rollback, the `0.2.1` release/live-attestation run, Marketplace public install, final vulnerability approval, signed source-to-binary provenance, and artifact signing remain incomplete. |
