...
| `MIG-012` | release-blocker | Generated NOTICE evidence, exact `0.2.2` candidate contract, historical `0.2.0` attestation evidence, secretless Marketplace workflow, #20 bounded owner exception, vulnerability decisions, and native artifact mapping | Final NOTICE/license publication and legal review, the `0.2.2` release/live attestation, Marketplace publication/public install, signed provenance, artifact signing, and final vulnerability approval are not complete. |
