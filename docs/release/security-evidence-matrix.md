...
| `SEC-015` | release-blocker | Deterministic `0.2.3` pre-release VSIX/package evidence, exact pending candidate contract, candidate/historical provenance separation, live `0.2.2` custom-predicate attestation and Marketplace publication evidence, vulnerability decisions, and native artifact mapping | Final SBOM/NOTICE/legal and vulnerability approval, reproducible or signed source-to-binary provenance, and artifact signing are not complete. |
...
| `MIG-009` | release-blocker | M7 release gates, staged/installed `win32-x64` evidence, M7j2a provenance, M7j3 renderer evidence, M7k2a listing metadata, exact deterministic `0.2.3` pending pre-release VSIX, and live `0.2.2` attestation and Marketplace Gallery state | Signing/provenance trust and previous-stable upgrade/rollback are not complete. |
...
| `MIG-012` | release-blocker | Generated NOTICE evidence, exact `0.2.3` pending candidate contract, live `0.2.2` attestation and Marketplace publication evidence, #43 bounded owner exception, vulnerability decisions, and native artifact mapping | Final NOTICE/license publication and legal review, signed provenance, artifact signing, and final vulnerability approval are not complete. |
...
| `TST-024` | release-blocker | Installed package/workflow/UI evidence, deterministic `0.2.3` pre-release VSIX tests, candidate-versus-historical provenance/publication/Beta-G separation tests, successful `0.2.2` attestation and Marketplace publication runs, vulnerability gates, native artifact mapping, and Source Control UI E2E evidence | Previous-stable upgrade/rollback, final vulnerability approval, signed source-to-binary provenance, and artifact signing remain incomplete. |
